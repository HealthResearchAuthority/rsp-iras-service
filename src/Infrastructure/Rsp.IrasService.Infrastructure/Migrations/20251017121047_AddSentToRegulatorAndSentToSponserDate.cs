...
{
    /// <inheritdoc />
    public partial class AddSentToRegulatorAndSentToSponserDate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.RenameColumn(
                ...
                newName: "SentToSponsorDate");

            migrationBuilder.AddColumn<DateTime>(
                name: "SentToRegulatorDate",
                table: "ProjectModifications",
                type: "datetime2",
                nullable: true);
