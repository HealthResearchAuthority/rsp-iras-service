...
public class DisableSponsorOrganisationTests : TestServiceBase<SponsorOrganisationsService>
{
        ...
        Generator<SponsorOrganisation> generator)
    {
        ...
        // Act
        var result = await Sut.DisableSponsorOrganisation(targetUser.RtsId);
