...
public class DisableUserInSponsorOrganisationTests : TestServiceBase<SponsorOrganisationsService>
{
    private readonly IrasContext _context;
    private readonly SponsorOrganisationRepository _sponsorOrganisationRepository;

    public DisableUserInSponsorOrganisationTests()
    {
        ...
        Generator<SponsorOrganisationUser> generator)
    {
        ...
        // Act
        var result = await Sut.DisableUserInSponsorOrganisation(targetUser.RtsId, targetUser.UserId);
